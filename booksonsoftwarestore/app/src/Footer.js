    ...
    <footer>
        ...
        <div className="main-footer col-md-12 col-xs-12">
          <div className="foter-logo col-md-3 col-sm-3 col-xs-2">
            <a href="index.html">
              <img
                className="desktop"
                src="images/BannerGen.jpg"
                alt=""
              />
              <img className="mobileImg" src="images/BannerGen.jpg" alt="" />
            </a>
          </div>
      ...
      <div className="video-sec col-md-4 col-sm-12 col-xs-12">
        <h1 className="video-heading text-center">
          <img src="images/TileGen.jpg" alt="" />
        </h1>
        <span className="border"></span>
        <p className="footer-p">
          This site offers books to help a software developer
